...
def compile_patient_summary_table(patient_name: str, db_records: List[Dict[str, Any]] = None, patient_records: List[Dict[str, Any]] = None) -> str:
    """Build a rich markdown report from medical_records and patient_records tables."""
    history_items, allergy_items, medication_items, family_items = [], [], [], []
    test_rows, surgery_rows, visit_rows = [], [], []
    clinical_summaries = []

    # 1. Process patient_records (AI intake summary + visit reports)
    if patient_records:
    ...
    lines = [f"## Medical Record & History for {patient_name}", ""]
        ...
        async def get_patient_summary(patient_name: str) -> str:
            ...
            try:
                ...
                try:
                    ...
                    summary_table = compile_patient_summary_table(resolved_name, db_records, patient_records)
